...
try {
var yogipw = db.get("yogipw");
} catch (e) {
	console.log('')
}

var creatorList = ['@yogi','@yogipw','@yogicuk','@yogi', '@yogans','@yogigi','@yogii'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'yogipw') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'yogipw') return res.json(loghandler.invalidKey)
